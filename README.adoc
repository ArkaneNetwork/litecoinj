...
venly build: 
[![Build](https://github.com/ArkaneNetwork/litecoinj/actions/workflows/build.yml/badge.svg)](https://github.com/ArkaneNetwork/litecoinj/actions/workflows/build.yml)
